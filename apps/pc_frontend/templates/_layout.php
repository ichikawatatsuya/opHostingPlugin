...
<?php //ログインしているページ ?>
<?php $skinUnited = Doctrine::getTable('Plugin')->findOneByName('opSkinUnitedPlugin') ?>
<?php if (0 >= count($skinUnited) || 0 === (int)$skinUnited['is_enabled']): ?>
